 ...
 * @argv: An array of strings containing the arguments that is passed to the program.
 * Description: The overall goal of this program is to copy the contents of a file
